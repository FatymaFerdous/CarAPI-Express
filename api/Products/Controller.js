...
const createProduct = async (req, res) => {
    const { ProductName, description, price, category, brand, colors, thumbnail, imageArray, modelYear, discountPercentage, rating, stock } = req.body
    ...
    if (!ProductName || !description || !price || !category || !colors || !brand || !thumbnail || !imageArray || !modelYear || !discountPercentage || !rating || !stock) {
        ...
        try {
            ...
            if (checkExistingProduct) {
                ...
                await Product.create({ ProductName, description, price, category, colors, brand, thumbnail, imageArray, modelYear, discountPercentage, rating, stock })
